...
export const littleEasterEggSupabase = `[To celebrate the Supabase Special Announcement on April 15th](https://supabase.com/special-announcement) we're running a special 10 day open source hackathon.
