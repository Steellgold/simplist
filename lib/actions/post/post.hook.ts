...
import { createPost, deletePost, getPost, getPostBySlug, getPosts, updatePost } from "./post.action";
...
export const useDeletePost = (): UseMutationResult<unknown, unknown, string, unknown> => {
  const queryClient = useQueryClient();
